---
name: ux-copy
description: Creates and reviews user-facing copy for software interfaces including buttons, labels, error messages, tooltips, notifications, onboarding flows, and empty states. Invoked when asked to write, review, or refine UI copy in English. For translation, use translating-i18n skill instead.
---
