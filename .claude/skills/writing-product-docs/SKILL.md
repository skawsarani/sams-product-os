---
name: product-docs
description: Generates complete PM documents (PRDs, specs, briefs, user stories, decision docs) from templates and knowledge base context. Invoked via /write-prd, /write-brief, /write-spec, /write-user-stories, /write-decision, or requests like "generate a PRD". For collaborative writing, use doc-coauthoring instead.
---
...
**product-docs** = automated PM document generation from templates and knowledge base.
**doc-coauthoring** = collaborative, iterative writing with user through conversation.

Use product-docs for immediate, complete first drafts. Use doc-coauthoring for guided, iterative writing.
...
1. **Existing related documents**:
   ...
   - Check `initiatives/` for existing specs/briefs/initiatives
...
- Primary: `knowledge/opportunities/`, `initiatives/`
