...
## Table of Contents
- [Source Priority Strategy](#source-priority-strategy)
- [Source 1: Knowledge Base Files](#source-1-knowledge-base-files)
- [Source 2: Notion Workspace](#source-2-notion-workspace)
- [Source 3: Web Search](#source-3-web-search)
- [Source 4: User Input](#source-4-user-input)
- [Multi-Source Validation](#multi-source-validation)
- [Handling Source Failures](#handling-source-failures)
- [Source Selection Decision Tree](#source-selection-decision-tree)
...
### What It Is
Markdown files in `knowledge/references/` and `meetings/` that contain user-provided research, notes, or interview transcripts.
...
Glob(pattern="*[competitor-name]*.md", path="meetings/")
```
