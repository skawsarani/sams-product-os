...
description: Comprehensively analyzes a single competitor including features, pricing, target customers, strengths, gaps, and market positioning. Also orchestrates multi-competitor research via /competitor-research. Invoked when asked to research, analyze, or compare against a specific competitor.
---
...
- [Multi-Competitor Research](#multi-competitor-research) (via /competitor-research)
...
Orchestrates research across multiple competitors in parallel and synthesizes into a comparison matrix. Invoked via `/competitor-research`.
