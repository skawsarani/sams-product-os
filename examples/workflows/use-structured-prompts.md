...
- **Process BACKLOG.md**: See @examples/workflows/process-backlog.md
- **Expand Initiative**: See @examples/workflows/prioritize-work.md
- **Generate PRD**: See @examples/workflows/generate-docs.md
- **Research Synthesis**: See @examples/workflows/synthesize-research.md
