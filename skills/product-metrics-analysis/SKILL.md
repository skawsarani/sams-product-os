---
name: product-metrics-analysis
description: Analyze product metrics (usage, features, adoption, conversion, retention, revenue, payments/fintech) and identify patterns in user behavior. Use when asked to analyze product data, interpret metrics, identify trends, understand funnel performance, assess feature adoption, evaluate product-market fit, analyze cohorts, or analyze payment/fintech metrics (TPV, GMV, take rate, payment acceptance rate, chargeback rate, ATV, fraud rate). Provides data-driven insights from CSV/Excel exports, SQL results, JSON data, or analytics dashboard descriptions. Applies appropriate PM frameworks (AARRR, North Star, PMF metrics, cohort analysis) based on context.
---
